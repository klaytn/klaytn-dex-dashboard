...
If you find a bug or other issues in klaytn-dex-dashboard, please [submit an issue](https://github.com/klaytn/klaytn-dex-dashboard/issues). Before submitting an issue, please invest some extra time to figure out that:

- The issue is not a duplicate issue.
- The issue has not been fixed in the latest release of klaytn-dex-dashboard.
...
After confirming your report meets the above criteria, [submit the issue](https://github.com/klaytn/klaytn-dex-dashboard/issues). Please use [labels](#usage-of-labels) to categorize your issue.

### Feature Requests

You can also use the [issue tracker](https://github.com/klaytn/klaytn-dex-dashboard/issues) to request a new feature or enhancement. Note that any code contribution without an issue link will not be accepted. 
...
Before you submit a pull request, please check formatting errors.Otherwise, the test on CircleCI will fail, and this prevents merging.
